...
# ORB-SLAM3 with Stereo-NEC
##  Project Overview
Stereo-NEC aims to improve the initialization accuracy and robustness of stereo VI-SLAM systems.
We release a version of the code with features integrated into ORB-SLAM3 to demonstrate the concept. **However, the comprehensive code version used in our proprietary SLAM system, intended for product use, will not be released.**
